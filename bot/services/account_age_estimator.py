...
class AccountAgeEstimator:
    ...
    def create_default_mapping(self) -> None:
        ...
        default_mapping = [
            ...
            # 2025: Прогноз (консервативный)
            [5500000000, 1738368000],  # 1 февраля 2025 - ~5.5B
            [6000000000, 1748822400],  # 1 июня 2025 - ~6B (прогноз)
            [7000000000, 1780358400],  # 1 июня 2026 - ~7B (прогноз)
        ]
